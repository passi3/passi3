...
- enjoy turning real user problems into simple, reliable solutions

---

## Education
- **SeSAC iOS Devloper**  
  _2025.12.29 ~ 2026.05. 29
  - Studied `iOS`, `Reactive Programming`, `Concurrency`, with `UIKit`, `SwiftUI`, `Combine`, `RxSwift`, etc.
  - Built and successfully published an iOS application to the App Store
  - Experienced the full app development lifecycle, from planning and implementation to testing, release, and maintenance
    
- **Boostcamp AI Tech – Recommender System Track**  
  _2024.08.05 ~ 2025.02.12_  
  - Studied `ML`, `DL`, `Statistics` with `pandas`, `NumPy`, `PyTorch`, `WandB`, `Git`, `Docker`, etc.  
